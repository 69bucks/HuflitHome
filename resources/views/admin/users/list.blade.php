										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="admin/users/edit/{{$tk->id}}"><i class="glyphicon glyphicon-edit"></i> Chỉnh sửa</a></li>
													<li><a href="admin/users/del/{{$tk->id}}"><i class="glyphicon glyphicon-trash"></i> Xóa</a></li>
												</ul>
											</li>
										</ul>
									</td>
