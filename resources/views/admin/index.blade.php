...
<div class="content-wrapper">
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4></i> <span class="text-semibold">Home</span> - Trang Quản Lý</h4>
			</div>
		</div>
	...
	<div class="content">
		...
		Copyright &copy;
				<script>document.write(new Date().getFullYear());</script> All rights reserved | Trang web được xây dựng bởi Nhóm 16</div>
		<!-- /footer -->
	</div>
</div>
@endsection