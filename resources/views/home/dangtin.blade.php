...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<h1 class="entry-title entry-prop">Đăng tin Bất động sản</h1>
			<hr>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="txtprice" class="form-control" placeholder="Nhập giá bất động sản.." >
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
      ...
      <div class="row">
       <div class="col-md-4 text-center">
        @if(Auth::user()->avatar == 'no-avatar.jpg')
					<img alt="" size="80" src="images/no-avatar.jpg" class="img-circle" alt="Cinque Terre" width="100" height="100">
        @else
					<img alt="" size="80" src="uploads/avatars/{{Auth::user()->avatar}}" class="img-circle" alt="Cinque Terre" width="100" height="100">
        @endif 
      </div>
      <div class="col-md-8">
...
<script>
  ...
  function initialize() {
    var mapOptions = {
      center: {lat: 10.7759946, lng: 106.6651815},
      zoom: 12
    };
  ...
  function handleNoGeolocation(errorFlag) {
    ...
    var options = {
      map: map,
      zoom: 19,
      position: new google.maps.LatLng(10.7759946,106.6673702,),
      content: content
    };
