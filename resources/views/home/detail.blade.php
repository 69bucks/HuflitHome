...
<div class="container">
   <div class="row">
      <div class="col-md-8">
         ...
         <div class="row">
            <div class="col-md-6">
               <span class="price_area">{{ number_format($motelroom->price) }} <span class="price_label">VNĐ</span></span>
            </div>
            <div class="col-md-6">
         ...
         <div class="detail">
            ...
            <p>
               <strong>Giá phòng: </strong><span class="price_area"><?php echo number_format($motelroom->price); ?>  <span class="price_label">VNĐ</span></span>
   ...
   <div class="col-md-4">
      <div class="contactpanel">
         <div class="row">
            ...
            <div class="col-md-8">
               ...
               <i class="far fa-clock"></i> Ngày tham gia: {{ time_elapsed_string(Auth::user()->created_at) }}
            </div>
         </div>
      </div>
      <div class="phone_btn">
      ...
      @endif
      <img src="images/banner-1.jpg" width="100%" style="margin-top: 20px">
   </div>
</div>
</div>
...
<script>
   ...
   function initMap() {
   	map = new google.maps.Map(document.getElementById('map-detail'), {
   		center: {lat: 10.8092919, lng: 106.7201746},
   		zoom: 15,
   		draggable: true
   	});
