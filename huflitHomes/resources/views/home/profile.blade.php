	...
	<div class="row">
		<div class="col-12">
			<div class="banner-info mb-5">
				<div class="mapInfo false" data-reactid="47">
					@if(Auth::user()->avatar == 'no-avatar.jpg')
					<img alt="" size="80" src="images/no-avatar.jpg" class="avatar" data-reactid="57">
					@else
					<img alt="" size="80" src="uploads/avatars/{{Auth::user()->avatar}}" class="avatar" data-reactid="57">
					@endif
					<a href="user/profile/edit">
						<div class='add-button'><i class='far fa-edit' style="padding-left: 4px; font-size: 19px;"></i></div>
					</a>					
				</div>
				<div class="info">
			...
			<div class="mypage">
				...
				<div class="mainpage">
					...
					<div class="alert alert-info">
						Bạn chưa có tin đăng Bất động sản nào, thử đăng ngay?
					</div>
