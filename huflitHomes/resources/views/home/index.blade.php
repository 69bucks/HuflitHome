...
<div class="search-map hidden-xs" >
               ...
               <form onsubmit="return false">
                  ...
                  <div class="form-group row" style="padding: 0 20px">
                     <p style="color: #ffffff; font-style: italic "> *Chọn loại bất động sản và khoảng giá, sau đó bấm vào biểu tượng
                        ...
                        vùng khu vực mà bạn muốn tìm kiếm
                     </p>
                  </div>
               </form>
            </div>
   ...
   <div class="container">
      <h3 class="title-comm"><span class="title-holder">TIN ĐĂNG MỚI NHẤT</span></h3>
      <div class="row room-hot">
...
<div class="container">
   <h3 class="title-comm"><span class="title-holder">PHÒNG TRỌ HỒ CHÍ MINH</span></h3>
   <div class="row">
      <div class="col-md-8">
...
<script>
   	...
   	function initMap() {
		map = new google.maps.Map(document.getElementById('map'), {
			center: {lat: 10.7757626, lng: 106.6630041},
			zoom: 12,
			draggable: true
		});
