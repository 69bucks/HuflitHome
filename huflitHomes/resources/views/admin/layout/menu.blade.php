						...
						<div class="category-content">
							<div class="media">
								<div class="media-body pt-5">
									<span class="media-heading text-semibold" style="color: aqua">Hi! {{ Auth::user()->name }} (Admin)</span>
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> Hồ Chí Minh
									</div>
								</div>								
							</div>
						</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="admin/motelrooms/list"><i class="icon-home4"></i> <span>Danh sách Bất động sản</span></a></li>
